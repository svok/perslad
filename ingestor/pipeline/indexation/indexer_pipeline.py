...
from .indexer_pipeline_builder import IndexationPipelineBuilder
...
from ..impl.text_splitter_helper import TextSplitterHelper
...
class IndexationPipeline:
    ...
    def __init__(self, workspace_path: Path, storage, llm, lock_manager,
        ...
        self._ctx = IndexationPipelineContext(
            ...
            config=self.config,
            text_splitter_helper=self.text_splitter_helper
        )
